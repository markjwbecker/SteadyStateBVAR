...
Let us choose 4 markov chains, with each having 10000 iterations, and where 2500 of those 10000 are warmup/burn-in iterations.
...
![plot of chunk AR(1)-5](figure/AR(1)-5-1.png)![plot of chunk AR(1)-5](figure/AR(1)-5-2.png)![plot of chunk AR(1)-5](figure/AR(1)-5-3.png)
...
![plot of chunk AR(1)-6](figure/AR(1)-6-1.png)![plot of chunk AR(1)-6](figure/AR(1)-6-2.png)![plot of chunk AR(1)-6](figure/AR(1)-6-3.png)
