...
are $u_t \overset{\text{iid}}{\sim} \mathrm{N_k}(0,\Sigma_u)$. Here
$\Pi_\ell$ for $\ell=1,\dots,p$ is a $(k \times k)$ autoregressive
parameter matrix, and $\Psi$ is a $(k \times q)$ steady-state parameter
matrix. Now
...
of freedom. As mentioned, this package also allows for stochastic
