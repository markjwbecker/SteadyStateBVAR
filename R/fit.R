...
#' \item \code{x$fit$posterior_means}: List of elementwise posterior mean estimates
#' \item \code{x$fit$posterior_medians}: List of elementwise posterior median estimates
#' }
#'
#' @details
