...
estimate \\\beta, \Psi\\, and \\\Sigma_u\\, so priors are needed. First,
prior independence between \\\beta, \Psi\\ and \\\Sigma_u\\ is assumed.
Starting with \\\beta\\, we use the Minnesota prior
...
\\\theta\_\Psi\\, we specify our prior beliefs about the location of the
steady state, and in \\\Omega\_\Psi\\, which we assume to be a diagonal
...
vary over time (i.e. we have\\\Sigma\_{u,t}\\, more details are found in
