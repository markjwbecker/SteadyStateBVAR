...
Then generate the shock to the VAR $u_{T+h}^{(j)}$ from $u_{T+h} \sim N(0,\Sigma_{u,T+h}^{(j)})$ and then calculate the forecast $\tilde{y}_{T+h}^{(j)}$ as per the usual way [see step 4 in Algorithm 4 in Karlsson (2013)].
