...
Now lets input everything to the 'priors' function and then append that to 'stan_data'. We also need to attach the dummy variable. Note here that $\theta_\beta$ and $\Omega_\beta$ are automatically created, we just need to input the prior means for the first own lags and then the hyperparameters $\lambda_1$ and $\lambda_2$.
