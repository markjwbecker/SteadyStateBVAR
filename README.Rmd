...
from $\epsilon_{T+h} \sim \mathcal{N}(0, \textrm{I}_k)$. Now compute the shock to the VAR
...
Since the log volatilities are Random Walks now, their steady states do not exist, and as such we specify some arbitrary initial conditions $\lambda_0$
...
Note here that the inverse gamma $\mathcal{IG}(\alpha, \beta)$ distribution is the univariate version of the inverse Wishart distribution with $\alpha=m/2, \ \beta = V/2$.
