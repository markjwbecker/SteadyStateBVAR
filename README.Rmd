...
where $V$ is the scale matrix and $m\geq k+2$ is the number of degrees of freedom. This package also allows for stochastic volatility (Random Walk or AR1 specifications), where the covariance matrix varies over time, i.e. we have $\Sigma_{u,t}$ (see `?bvar` for more details).
