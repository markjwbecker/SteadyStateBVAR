...
We can also do some impulse response analysis. We can choose between the orthogonalized impulse response function (OIRF) and the generalized impulse response function (GIRF). Lets first try with the stan-estimated model
...
And now with Gibbs. We can see that they are very similar (as they should be it is the exact same model but estimated with two different samplers)
