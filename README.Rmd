...
where $V$ is the scale matrix and $m\geq k+2$ is the number of degrees of freedom. As mentioned, this package also allows for stochastic volatility (Random Walk or AR(1) specifications), where the covariance matrix varies over time, i.e. we have $\Sigma_{u,t}$ (see `?bvar` for more details).
