...
Only a constant this time, i.e. $d_t=1 \ \forall \ t$, thus $q=1$. The lag order $p$ is not specified, but looking at Gustafsson, Villani and Stockhammar (2023) (same data etc.) we can infer that they use $p=2$.
...
```{r, fig.width=8, fig.height=16,eval=TRUE, results='hide'}
rm(bvar_obj)
bvar_obj <- bvar(data = yt)
