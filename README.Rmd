...
We continue with the same data/model as in the previous section. Now suppose we are interested in the forecast of inflation $\Delta \pi_t$ and the unemployment rate $\u_t$ conditional on a scenario where the three month Treasury bill rate (a proxy for the federal funds rate) rises a lot very quickly and unexpectedly, and the goes back down (this is just a toy example).
