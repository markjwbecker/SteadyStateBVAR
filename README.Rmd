...
You can install the development version of SteadyStateBVAR from [GitHub](https://github.com/markjwbecker/SteadyStateBVAR) with:
...
Now we need to specify the prior variances for the steady state coefficients. Let us put a strong prior on inflation, since the Swedish central bank has a 2\% inflation target. For the other variables, we can just put 1 as the variance. We assume prior independence of the steady states. Note that the variances are for the elements in vec(Lambda_pr_means).
