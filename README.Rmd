...
```{r, fig.width=8, fig.height=8, eval=FALSE, eval=FALSE}
theta_Psi <- 
  c(
...
```{r, fig.width=8, fig.height=8, message=FALSE, warning=FALSE, eval=FALSE}
bvar_obj$predict$H <- 12
...
Looks like it works quite well! Now let us plot the estimates (posterior mean and 95\% interval) of stochastic volatilities from the model, defined as reduced form residual/innovation ($u_t$) standard deviations (diagonal elements of $\Sigma_{u,t}^{0.5}$).
