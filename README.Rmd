...
Now let us plot the estimates (posterior means) of the log volatilities ($\ln (\lambda_t)$ in red. In grey, we plot the true unobserved/latent process. In blue we plot the forecasts of the log volatilities along with a 95\% prediction interval.
