...
\\ \Psi d_t = \mu_t = \begin{cases} \psi_1 + \psi_2 & \text{if } t \le
1992Q4 \\ \psi_1 & \text{if } t \> 1992Q4 \end{cases} \\
...
submatrix of \\\Pi\_\ell'\\, to the zero matrix. This technique is
called “block exogeneity” (Dieppe, Legrand, and van Roye, 2016). In
essence we treat the foreign economy as exogenous to the domestic
economy. Although, it is not exogenous in the strict sense, it is
actually a statement about Granger causality. That, in a small open
economy model, we do not expect the domestic variables to be useful for
forecasting the variables representing the rest of the world (Karlsson,
2013).
...
For the estimation, let us choose 4 markov chains, with each having
15000 iterations, and where 5000 of those 15000 are warmup/burn-in
iterations.
...
us plot the posterior draws of the steady-state of inflation before and
after 1992Q4, i.e. \\\mu\_{t=48,i=5}\\ and \\\mu\_{t=49,i=5}\\.
