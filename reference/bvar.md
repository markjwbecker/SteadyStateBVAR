...
Initialises a Bayesian Vector Autoregression (BVAR) model object. This
is the starting point for all models in `SteadyStateBVAR`. After
creation, pass the object sequentially to
