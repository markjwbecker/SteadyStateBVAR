...
- response:
  ...
  Integer vector. Indices of the response variables to plot. If `NULL`
  (default), all responses are plotted.

- impulse:

  Integer vector. Indices of the impulse variables to plot. If `NULL`
