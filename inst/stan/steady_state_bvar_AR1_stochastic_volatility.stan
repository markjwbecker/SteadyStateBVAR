...
transformed data {
    ...
    vector[k] Omega_gamma_0_diag = sqrt(diagonal(Omega_gamma_0));
    vector[k] Omega_gamma_1_diag = sqrt(diagonal(Omega_gamma_1));
}
...
model {
  ...
  gamma_0         ~ normal(theta_gamma_0, Omega_gamma_0_diag);
  gamma_1         ~ normal(theta_gamma_1, Omega_gamma_1_diag);
